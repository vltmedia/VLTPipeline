...
class ClientEdit(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.layoutWidget_7.setGeometry(QRect(850, 40, 341, 43))
        ...
        self.layoutWidget_8.setGeometry(QRect(850, 90, 341, 196))
        ...
        self.pushButtonUserAdd_2 = QPushButton(self.layoutWidget_8)
        self.pushButtonUserAdd_2.setObjectName(u"pushButtonUserAdd_2")

        self.horizontalLayout_6.addWidget(self.pushButtonUserAdd_2)

        self.pushButtonUserMinus_2 = QPushButton(self.layoutWidget_8)
        self.pushButtonUserMinus_2.setObjectName(u"pushButtonUserMinus_2")

        self.horizontalLayout_6.addWidget(self.pushButtonUserMinus_2)


        self.verticalLayout_7.addLayout(self.horizontalLayout_6)

        self.tableViewContacts = QTableView(self.layoutWidget_8)
        self.tableViewContacts.setObjectName(u"tableViewContacts")

        self.verticalLayout_7.addWidget(self.tableViewContacts)
        ...
        self.pushButton.clicked.connect(self.parent.ClickedA)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(QCoreApplication.translate("Form", u"Client Name", None))
        ...
        self.label_11.setText(QCoreApplication.translate("Form", u"Website", None))
        self.label_12.setText(QCoreApplication.translate("Form", u"Contacts", None))
        self.pushButtonUserAdd_2.setText(QCoreApplication.translate("Form", u"+", None))
        self.pushButtonUserMinus_2.setText(QCoreApplication.translate("Form", u"-", None))
        self.tabWidgetInfo.setTabText(self.tabWidgetInfo.indexOf(self.tab_4), QCoreApplication.translate("Form", u"Info", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"Groups", None))
        ...
        self.tabWidgetInfo.setTabText(self.tabWidgetInfo.indexOf(self.tab_2), QCoreApplication.translate("Form", u"Groups", None))
        self.label_7.setText(QCoreApplication.translate("Form", u"Projects", None))
        ...
        self.tabWidgetInfo.setTabText(self.tabWidgetInfo.indexOf(self.tab_3), QCoreApplication.translate("Form", u"Projects", None))
        self.label_10.setText(QCoreApplication.translate("Form", u"Users", None))
        ...
        self.tabWidgetInfo.setTabText(self.tabWidgetInfo.indexOf(self.tab), QCoreApplication.translate("Form", u"Users", None))
    # retranslateUi
